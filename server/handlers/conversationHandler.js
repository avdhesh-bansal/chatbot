...
var AssistantV1 = require('watson-developer-cloud/assistant/v1'),
    ...
    assitant = new AssistantV1({ version: '2018-02-16'});
 ...
 */
 function callWatsonAssistant(params) {
		...
		return new Promise(function(resolve, reject){
		    ...
		    assitant.message(payload, function(err, conversationResp) {
					if (err) {
		        return reject(err);
		      }
...
function callWatsonDiscovery(conversationResp){
	...
	methods.getLogs = function(payload){
		return new Promise(function(resolve, reject){
				console.log("IN conversationHandler.getLogs, payload: >>> ", payload);
					assitant.listLogs(payload, function(err, logsResp) {
					if (err) {
		        return reject(err);
		      }
